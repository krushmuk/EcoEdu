        ...
        <section className="bg-[#f5f5f5] py-12 md:py-20">
          <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              Революционное открытие раскрывает новый подход к возобновляемым источникам энергии
              </h1>
              <p className="text-gray-600 text-lg">
              Исследователи представили революционную технологию, которая использует силу природы для производства чистая, устойчивая энергия. Этот прорыв может проложить путь к более «зеленому» будущему.
              </p>
              <Link
                href="/event"
